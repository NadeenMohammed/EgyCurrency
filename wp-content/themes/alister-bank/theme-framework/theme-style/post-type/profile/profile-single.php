...
if (
	$cmsmasters_option['alister-bank' . '_profile_post_cat'] || 
	$cmsmasters_option['alister-bank' . '_profile_post_comment'] || 
	(
...
<article id="post-<?php the_ID(); ?>" <?php post_class('cmsmasters_open_profile'); ?>>
	...
	if ($profile_sidebar == 'true') {
		echo '<div class="profile_sidebar">';
			...
			alister_bank_profile_open_social_icons($cmsmasters_profile_social, get_the_ID(), esc_html__('Socials', 'alister-bank'), 'h3');
...
if ($cmsmasters_profile_sharing_box == 'true') {
	alister_bank_sharing_box(esc_html__('Like this profile?', 'alister-bank'), 'h3');
}


if ($cmsmasters_option['alister-bank' . '_profile_post_nav_box']) {
	$order_cat = (isset($cmsmasters_option['alister-bank' . '_profile_post_nav_order_cat']) ? $cmsmasters_option['alister-bank' . '_profile_post_nav_order_cat'] : false);
