...
if (
	$cmsmasters_option['alister-bank' . '_portfolio_project_like'] || 
	$cmsmasters_option['alister-bank' . '_portfolio_project_date'] || 
	$cmsmasters_option['alister-bank' . '_portfolio_project_cat'] || 
	$cmsmasters_option['alister-bank' . '_portfolio_project_comment'] || 
	$cmsmasters_option['alister-bank' . '_portfolio_project_author'] || 
	$cmsmasters_option['alister-bank' . '_portfolio_project_tag'] || 
...
if ($cmsmasters_option['alister-bank' . '_portfolio_project_nav_box']) {
	$order_cat = (isset($cmsmasters_option['alister-bank' . '_portfolio_project_nav_order_cat']) ? $cmsmasters_option['alister-bank' . '_portfolio_project_nav_order_cat'] : false);
...
if ($cmsmasters_project_sharing_box == 'true') {
	alister_bank_sharing_box(esc_html__('Like this project?', 'alister-bank'), 'h2');
}


if ($cmsmasters_project_author_box == 'true') {
	alister_bank_author_box(esc_html__('About author', 'alister-bank'), 'h2', 'h4');
}
...
if ($cmsmasters_project_more_posts != 'hide') {
	alister_bank_related( 
		'h2', 
		esc_html__('More projects', 'alister-bank'), 
		esc_html__('No projects found', 'alister-bank'), 
		$cmsmasters_project_more_posts, 
		$tgsarray, 
		$cmsmasters_option['alister-bank' . '_portfolio_more_projects_count'], 
		$cmsmasters_option['alister-bank' . '_portfolio_more_projects_pause'], 
		'project', 
		'pj-tags' 
	);
}
