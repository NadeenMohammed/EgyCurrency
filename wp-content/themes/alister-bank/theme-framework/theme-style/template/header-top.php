...
if ($cmsmasters_option['alister-bank' . '_header_top_line']) {
	echo '<div class="header_top" data-height="' . esc_attr($cmsmasters_option['alister-bank' . '_header_top_height']) . '">' . 
		'<div class="header_top_outer">' . 
			'<div class="header_top_inner">' .
				...
				if (
					$cmsmasters_option['alister-bank' . '_header_top_social'] &&  
				...
				if (
					$cmsmasters_option['alister-bank' . '_header_top_nav'] && 
				...
				if ($cmsmasters_option['alister-bank' . '_header_top_line_short_info'] !== '') {
					echo '<div class="header_top_meta">' . 
						'<div class="meta_wrap">' . 
							stripslashes($cmsmasters_option['alister-bank' . '_header_top_line_short_info']) . 
						'</div>' . 
					'</div>';
				} 
