...
if (!function_exists('cmsmasters_fonts_list')) {
	function cmsmasters_fonts_list() {
		...
		if (isset($cmsmasters_option['alister-bank' . '_google_web_fonts']) && is_array($cmsmasters_option['alister-bank' . '_google_web_fonts'])) {
			$google_web_fonts_array = $cmsmasters_option['alister-bank' . '_google_web_fonts'];
