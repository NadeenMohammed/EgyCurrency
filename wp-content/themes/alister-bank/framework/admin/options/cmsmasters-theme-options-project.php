...
function alister_bank_get_custom_project_meta_fields() {
	...
	$custom_project_meta_fields = array( 
		...
		array( 
			...
			'desc'	=> esc_html__('Recommended Project Puzzle Image dimensions, or other size, with the same ratio:', 'alister-bank') . '</br>', 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (1px or No Gap)', 'alister-bank'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects 1px or no gap', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__('Project Puzzle Image (Large Gap)', 'alister-bank'), 
			'desc'	=> esc_html__('Choose image for Masonry Puzzle portfolio projects large gap', 'alister-bank'), 
