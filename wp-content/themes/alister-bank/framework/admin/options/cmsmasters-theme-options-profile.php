...
function alister_bank_get_custom_profile_meta_fields() {
	...
	$cmsmasters_global_profile_post_title = (isset($cmsmasters_option['alister-bank' . '_profile_post_title']) && $cmsmasters_option['alister-bank' . '_profile_post_title'] !== '') ? (($cmsmasters_option['alister-bank' . '_profile_post_title'] == 1) ? 'true' : 'false') : 'true';
	
	$cmsmasters_global_profile_post_details_title = (isset($cmsmasters_option['alister-bank' . '_profile_post_details_title']) && $cmsmasters_option['alister-bank' . '_profile_post_details_title'] !== '') ? $cmsmasters_option['alister-bank' . '_profile_post_details_title'] : '';
	
	$cmsmasters_global_profile_post_share_box = (isset($cmsmasters_option['alister-bank' . '_profile_post_share_box']) && $cmsmasters_option['alister-bank' . '_profile_post_share_box'] !== '') ? (($cmsmasters_option['alister-bank' . '_profile_post_share_box'] == 1) ? 'true' : 'false') : 'true';
	...
	$tabs_array['cmsmasters_profile'] = array( 
		'label' => esc_html__('Profile', 'alister-bank'), 
	...
	$custom_profile_meta_fields = array( 
		...
		array( 
			'label'	=> esc_html__('Profile Title', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__('Subtitle', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Details Title', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Social Icons', 'alister-bank'), 
			'desc'	=> esc_html__('Add social icons for this profile', 'alister-bank'), 
		...
		array( 
			'label'	=> esc_html__('Profile Info', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1 Title', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 1', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2 Title', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 2', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3 Title', 'alister-bank'), 
			'desc'	=> '', 
		...
		array( 
			'label'	=> esc_html__('Profile Features 3', 'alister-bank'), 
			'desc'	=> '', 
