...
function alister_bank_get_custom_other_meta_fields() {
	...
	$custom_other_meta_fields = array( 
		...
		array( 
			...
			'desc'	=> '</br>' . esc_html__('Choosing layout with a sidebar please make sure to add widgets in the Appearance - Widgets tab. The empty sidebar won\'t be displayed.', 'alister-bank'), 
			'id'	=> 'cmsmasters_layout', 
			'type'	=> 'radio_img', 
			'hide'	=> '', 
