...
if ( ! function_exists( 'wp_cache_phase2' ) ) {
	function wp_cache_phase2() { #to handle Nitropack
		return true;
	}
}
...
if (is_admin()) {
	...
	add_action('admin_bar_menu', array($wpadmin, 'createSoAdminMenu'), 2000);
}
...
if (isset($bv_is_third_party_host) && $bv_is_third_party_host === "true") {
		...
		$thirdpartycache->start_third_party_host_caching();
}
